                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: EdgeInsets.only(left: 5, top: 
...
saving empty
  ...
  void _showTodoSearchSheet(BuildContext context) {
    final _todoSearchDescriptionFormController = 
...
Colors.indigoAccent,
  ...
  Widget getTodosWidget() {
    ...
    and construct the UI (with state) based on the 
    stream
    */
...
AsyncSnapshot<List<Todo>> snapshot) {
  ...
  Widget getTodoCardWidget(AsyncSnapshot<List<Todo>> snapshot) {
    ...
    at initial state of the operation there will be no 
...
stream
    ...
    if (snapshot.hasData) {
      ...
      If that the case show user that you have empty 
      ...
      return snapshot.data.length != 0
          ? ListView.builder(
              ...
              itemBuilder: (context, itemPosition) {
                ...
                final Widget dismissibleCard = new 
                 Dismissible(
...
width: 0.5),
                      ...
                      child: ListTile(
                        leading: InkWell(
                          ...
                          /*
                            Another magic.
                            This will update Todo isDone with 
